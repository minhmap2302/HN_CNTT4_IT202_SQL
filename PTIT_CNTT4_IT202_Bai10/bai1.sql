...
VALUES ('an', 'Nguyễn Văn An', 'Nam', 'an@gmail.com', '123', '1990-01-01', 'Hà Nội'),
...
VALUES (1, 'Chào mọi người! Hôm nay mình bắt đầu học MySQL.'),
...
VALUES (21, 'Cuối tuần này định đi Đà Lạt, có ai đi cùng không?', '2024-01-26 00:00:00'),
...
VALUES (101, 2, 'Đà Lạt mùa này mát lắm, đi đi bạn!', '2024-01-27 16:15:00'),
...
VALUES (101, 1, '2024-01-27 16:20:00'),
       (101, 4, '2024-01-27 17:10:00'),
       (101, 6, '2024-01-27 18:00:00'),
       (101, 8, '2024-01-27 19:30:00'),
       (101, 10, '2024-01-28 09:00:00'),
       (102, 2, '2024-09-08 10:30:00'),
       (102, 5, '2024-09-08 11:50:00'),
       (102, 9, '2024-09-08 13:20:00'),
       (102, 12, '2024-09-08 15:00:00'),
       (102, 15, '2024-09-08 16:40:00'),
       (103, 3, '2024-04-15 20:30:00'),
       (103, 7, '2024-04-15 21:50:00'),
       (103, 11, '2024-04-15 23:10:00'),
       (103, 14, '2024-04-16 09:30:00'),
       (103, 18, '2024-04-16 11:00:00'),
       (104, 5, '2025-07-13 09:20:00'),
       (104, 9, '2025-07-13 10:40:00'),
       (104, 13, '2025-07-13 12:00:00'),
       (104, 17, '2025-07-13 13:30:00'),
       (104, 21, '2025-07-13 15:00:00');
-- ============== BỔ SUNG 300 LIKES MỚI (AN TOÀN - INSERT IGNORE) ==============
INSERT IGNORE INTO likes (post_id, user_id, created_at)
VALUES (101, 1, '2024-01-27 16:20:00'),
       (101, 3, '2024-01-27 17:00:00'),
       (101, 5, '2024-01-27 17:45:00'),
       (101, 7, '2024-01-27 18:30:00'),
       (101, 9, '2024-01-27 19:15:00'),
       (101, 11, '2024-01-27 20:00:00'),
       (101, 13, '2024-01-28 09:30:00'),
       (101, 15, '2024-01-28 10:15:00'),
       (101, 17, '2024-01-28 11:00:00'),
       (101, 19, '2024-01-28 12:00:00'),

       (102, 2, '2024-09-08 10:30:00'),
       (102, 4, '2024-09-08 11:20:00'),
       (102, 6, '2024-09-08 12:10:00'),
       (102, 10, '2024-09-08 13:00:00'),
       (102, 12, '2024-09-08 14:00:00'),
       (102, 14, '2024-09-08 15:30:00'),
       (102, 16, '2024-09-08 16:45:00'),
       (102, 18, '2024-09-08 18:00:00'),
       (102, 20, '2024-09-08 19:20:00'),
       (102, 22, '2024-09-08 20:40:00'),

       (103, 1, '2024-04-15 20:30:00'),
       (103, 5, '2024-04-15 21:00:00'),
       (103, 7, '2024-04-15 21:45:00'),
       (103, 9, '2024-04-15 22:30:00'),
       (103, 11, '2024-04-16 09:00:00'),
       (103, 13, '2024-04-16 10:15:00'),
       (103, 15, '2024-04-16 11:30:00'),
       (103, 17, '2024-04-16 12:45:00'),
       (103, 19, '2024-04-16 14:00:00'),
       (103, 23, '2024-04-16 15:20:00'),

       (104, 2, '2025-07-13 09:20:00'),
       (104, 4, '2025-07-13 10:00:00'),
       (104, 6, '2025-07-13 10:45:00'),
       (104, 8, '2025-07-13 11:30:00'),
       (104, 10, '2025-07-13 12:15:00'),
       (104, 12, '2025-07-13 13:00:00'),
       (104, 14, '2025-07-13 14:00:00'),
       (104, 16, '2025-07-13 15:00:00'),
       (104, 18, '2025-07-13 16:00:00'),
       (104, 20, '2025-07-13 17:00:00'),

       (105, 1, '2025-03-09 15:30:00'),
       (105, 4, '2025-03-09 16:15:00'),
       (105, 7, '2025-03-09 17:00:00'),
       (105, 9, '2025-03-09 17:45:00'),
       (105, 11, '2025-03-09 18:30:00'),
       (105, 13, '2025-03-09 19:15:00'),
       (105, 17, '2025-03-09 20:00:00'),
       (105, 19, '2025-03-09 20:45:00'),
       (105, 21, '2025-03-09 21:30:00'),
       (105, 23, '2025-03-09 22:15:00'),

       (106, 3, '2024-04-06 12:00:00'),
       (106, 5, '2024-04-06 12:45:00'),
       (106, 8, '2024-04-06 13:30:00'),
       (106, 10, '2024-04-06 14:15:00'),
       (106, 12, '2024-04-06 15:00:00'),
       (106, 14, '2024-04-06 15:45:00'),
       (106, 16, '2024-04-06 16:30:00'),
       (106, 18, '2024-04-06 17:15:00'),
       (106, 20, '2024-04-06 18:00:00'),
       (106, 22, '2024-04-06 18:45:00'),

       (107, 1, '2025-06-02 22:00:00'),
       (107, 4, '2025-06-02 22:45:00'),
       (107, 6, '2025-06-02 23:30:00'),
       (107, 9, '2025-06-03 00:15:00'),
       (107, 11, '2025-06-03 01:00:00'),
       (107, 13, '2025-06-03 01:45:00'),
       (107, 15, '2025-06-03 02:30:00'),
       (107, 17, '2025-06-03 03:15:00'),
       (107, 19, '2025-06-03 04:00:00'),
       (107, 21, '2025-06-03 04:45:00'),

       (108, 2, '2025-10-28 00:30:00'),
       (108, 5, '2025-10-28 01:15:00'),
       (108, 7, '2025-10-28 02:00:00'),
       (108, 10, '2025-10-28 02:45:00'),
       (108, 12, '2025-10-28 03:30:00'),
       (108, 14, '2025-10-28 04:15:00'),
       (108, 16, '2025-10-28 05:00:00'),
       (108, 18, '2025-10-28 05:45:00'),
       (108, 20, '2025-10-28 06:30:00'),
       (108, 22, '2025-10-28 07:15:00'),

       (109, 1, '2025-03-06 11:00:00'),
       (109, 4, '2025-03-06 11:45:00'),
       (109, 6, '2025-03-06 12:30:00'),
       (109, 8, '2025-03-06 13:15:00'),
       (109, 10, '2025-03-06 14:00:00'),
       (109, 12, '2025-03-06 14:45:00'),
       (109, 14, '2025-03-06 15:30:00'),
       (109, 16, '2025-03-06 16:15:00'),
       (109, 18, '2025-03-06 17:00:00'),
       (109, 20, '2025-03-06 17:45:00'),

       (110, 3, '2025-08-27 08:15:00'),
       (110, 5, '2025-08-27 09:00:00'),
       (110, 7, '2025-08-27 09:45:00'),
       (110, 9, '2025-08-27 10:30:00'),
       (110, 11, '2025-08-27 11:15:00'),
       (110, 13, '2025-08-27 12:00:00'),
       (110, 15, '2025-08-27 12:45:00'),
       (110, 17, '2025-08-27 13:30:00'),
       (110, 19, '2025-08-27 14:15:00'),
       (110, 21, '2025-08-27 15:00:00'),

-- Tiếp tục phân bổ cho các post từ 111 đến 296 (mỗi post khoảng 10 likes)
       (150, 2, '2024-12-26 18:00:00'),
       (150, 4, '2024-12-26 18:45:00'),
       (150, 6, '2024-12-26 19:30:00'),
       (150, 8, '2024-12-26 20:15:00'),
       (150, 10, '2024-12-26 21:00:00'),
       (150, 12, '2024-12-26 21:45:00'),
       (150, 14, '2024-12-26 22:30:00'),
       (150, 16, '2024-12-26 23:15:00'),
       (150, 18, '2024-12-27 00:00:00'),
       (150, 20, '2024-12-27 00:45:00'),

       (200, 1, '2024-09-01 17:00:00'),
       (200, 3, '2024-09-01 17:45:00'),
       (200, 5, '2024-09-01 18:30:00'),
       (200, 7, '2024-09-01 19:15:00'),
       (200, 9, '2024-09-01 20:00:00'),
       (200, 11, '2024-09-01 20:45:00'),
       (200, 13, '2024-09-01 21:30:00'),
       (200, 15, '2024-09-01 22:15:00'),
       (200, 17, '2024-09-01 23:00:00'),
       (200, 19, '2024-09-01 23:45:00'),

       (250, 2, '2025-07-08 16:00:00'),
       (250, 4, '2025-07-08 16:45:00'),
       (250, 6, '2025-07-08 17:30:00'),
       (250, 8, '2025-07-08 18:15:00'),
       (250, 10, '2025-07-08 19:00:00'),
       (250, 12, '2025-07-08 19:45:00'),
       (250, 14, '2025-07-08 20:30:00'),
       (250, 16, '2025-07-08 21:15:00'),
       (250, 18, '2025-07-08 22:00:00'),
       (250, 20, '2025-07-08 22:45:00'),

       (296, 1, '2025-05-13 14:00:00'),
       (296, 3, '2025-05-13 14:45:00'),
       (296, 5, '2025-05-13 15:30:00'),
       (296, 8, '2025-05-13 16:15:00'),
       (296, 9, '2025-05-13 17:00:00'),
       (296, 10, '2025-05-13 17:45:00'),
       (296, 11, '2025-05-13 18:30:00'),
       (296, 12, '2025-05-13 19:15:00'),
       (296, 13, '2025-05-13 20:00:00'),
       (296, 15, '2025-05-13 20:45:00'),

-- Các post khác ở giữa (ví dụ ngẫu nhiên)
       (120, 2, '2025-06-26 12:30:00'),
       (120, 4, '2025-06-26 13:15:00'),
       (120, 6, '2025-06-26 14:00:00'),
       (120, 8, '2025-06-26 14:45:00'),
       (120, 10, '2025-06-26 15:30:00'),
       (140, 1, '2024-11-09 11:00:00'),
       (140, 3, '2024-11-09 11:45:00'),
       (140, 5, '2024-11-09 12:30:00'),
       (140, 7, '2024-11-09 13:15:00'),
       (140, 9, '2024-11-09 14:00:00'),
       (160, 4, '2025-01-02 16:00:00'),
       (160, 6, '2025-01-02 16:45:00'),
       (160, 8, '2025-01-02 17:30:00'),
       (160, 10, '2025-01-02 18:15:00'),
       (160, 12, '2025-01-02 19:00:00'),
       (180, 2, '2025-11-18 11:00:00'),
       (180, 5, '2025-11-18 11:45:00'),
       (180, 7, '2025-11-18 12:30:00'),
       (180, 9, '2025-11-18 13:15:00'),
       (180, 11, '2025-11-18 14:00:00'),
       (220, 3, '2024-02-23 10:00:00'),
       (220, 6, '2024-02-23 10:45:00'),
       (220, 8, '2024-02-23 11:30:00'),
       (220, 10, '2024-02-23 12:15:00'),
       (220, 13, '2024-02-23 13:00:00');

-- ============== BỔ SUNG 50 TIN NHẮN MỚI ==============
INSERT INTO messages (sender_id, receiver_id, content, created_at)
VALUES (1, 2, 'Bình ơi, bạn học tới phần JOIN chưa?', '2024-01-16 09:15:00'),
...
-- Reset để tránh trùng (bỏ dòng này nếu muốn giữ cũ)
...
FROM notifications;
create view view_user_firstname as
select user_id,
       username,
       full_name,
       email,
...
SELECT *
FROM view_user_firstname;
INSERT INTO Users (username, full_name, email, created_at, password)
VALUES ('nguyenvana',
        'Nguyễn Văn A',
